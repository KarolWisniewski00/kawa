    ...
    <div class="container-fluid px-0">
            ...
            <div class="col-12 col-lg-6">
                <div class="d-flex flex-column justify-content-center align-items-center h-100">
                    <div class="d-flex flex-column justify-content-center align-items-center my-3 text-center">
                        <h3 class="mt-5 font-custom-2" style="color:#F9CAAC">FIRMA</h3>
                        <h1 class="font-custom">Szerokie spektrum smaków i esencji</h1>
                    </div>
                    <p class="lead text-center">Quickly design and customize responsive mobile-first sites with Bootstrap, the world’s most popular front-end open source toolkit, featuring Sass variables and mixins, responsive grid system, extensive prebuilt components, and powerful JavaScript plugins.</p>
                </div>
            </div>
        </div>
        ...
        <div class="row p-0 m-0 py-2" style="background-color:RGBA(249, 202, 172,0.25)">
            <div class="col-lg-4 col-md-12 mb-lg-0">
                <div class="d-flex flex-column justify-content-center align-items-center h-100">
                    <img src="{{ asset('image/Depositphotos_86094158_DS.jpg') }}" class="w-100 shadow-1-strong my-2" alt="" />

                    <img src="{{ asset('image/Depositphotos_123317734_DS.jpg') }}" class="w-100 shadow-1-strong my-2" alt="" />
                </div>
            </div>

            <div class="col-lg-4 mb-lg-0">
                <div class="d-flex flex-column justify-content-center align-items-center h-100">
                    <img src="{{ asset('image/Depositphotos_199823784_DS.jpg') }}" class="w-100 shadow-1-strong my-2" alt="" />

                    <img src="{{ asset('image/tumblr_5d5bebe25ba9df290cf9fd5a291bdc3d_a17f76db_1280.jpg') }}" class="w-100 shadow-1-strong my-2" alt="" />
                </div>
            </div>

            <div class="col-lg-4 mb-lg-0">
                <div class="d-flex flex-column justify-content-center align-items-center h-100">
                    <img src="{{ asset('image/tumblr_5a3db442661468c1334abb97561f158d_2c5ba144_500.jpeg') }}" class="w-100 shadow-1-strong my-2" alt="" />
                </div>
            </div>
        </div>
        <div class="row p-0 m-0 py-2">
