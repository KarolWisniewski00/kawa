        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('dashboard.shop.grinding.update', $grinding->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="mb-6">
                            <label for="name" class="block mb-2 text-sm font-medium text-gray-900">Nazwa rodzaju mielenia</label>
                            <input type="text" name="name" id="name" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="Wprowadź nazwę rodzaju mielenia" value="{{ old('name', $grinding->name) }}" required>
                            @error('name')
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="usage_information" id="usage_information" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="Wprowadź informacje o przeznaczeniu rodzaju mielenia" value="{{ old('usage_information', $grinding->usage_information) }}" required>
