        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
                    ...
                    <form action="{{route('dashboard.blog.update.second', $blog->id)}}" method="POST">
                        @method('PUT')
                        @csrf
                        <!-- Add the "Show More" button below the existing code -->
                        <div class="mb-6">
                            <h3 class="mb-5 text-lg font-medium text-gray-900">Zdjęcie głowne</h3>
                            <ul class="grid w-full gap-6 md:grid-cols-3" id="photoGrid">
                                ...
                                <li class="{{ $index >= 9 ? 'hidden' : '' }}">
                                    ...
                                    checked
                                    @else
                                    {{ $blog->photo == $photo->getFilename() ? 'checked' : '' }}
                        ...
                        <div class="mb-6">
                            ...
                            <input value="{{ old('title') ? old('title') : $blog->title}}" name="title" type="text" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Brazil Santos" required>
                            @error('title')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="mb-6">
                            ...
                            <textarea id="start" name="start" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Wpisz treść tutaj">{{ old('start') ? old('start') : $blog->start}}</textarea>
                            @error('start')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <ul class="grid w-full gap-6 md:grid-cols-3" id="photoGrid1">
                                ...
                                @foreach($photos as $index => $photo)
                                <li class="{{ $index >= 9 ? 'hidden' : '' }}">
                                    <input @if(old('photo1')==$photo->getFilename())
                                    checked
                                    @else
                                    {{ $blog->content_photo_1 == $photo->getFilename() ? 'checked' : '' }}
                                    @endif name="photo1" type="radio" id="photo1-{{ $photo->getFilename() }}" value="{{ $photo->getFilename() }}" class="hidden peer">
                            ...
                            <!-- "Show More" button -->
                            <button id="showMoreBtn1" type="button" class="mt-8 text-white bg-indigo-500 hover:bg-indigo-600 focus:ring-4 focus:ring-indigo-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 focus:outline-none"><i class="fa-solid fa-caret-down mr-2"></i>Pokaż więcej</button>
                            @error('photo1')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="content_text_1" name="content_text_1" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 " placeholder="Wpisz treść tutaj">{{ old('content_text_1') ? old('content_text_1') : $blog->content_text_1}}</textarea>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="content_text_2" name="content_text_2" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 " placeholder="Wpisz treść tutaj">{{ old('content_text_2') ? old('content_text_2') : $blog->content_text_2}}</textarea>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="content_text_3" name="content_text_3" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 " placeholder="Wpisz treść tutaj">{{ old('content_text_3') ? old('content_text_3') : $blog->content_text_3}}</textarea>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="content_text_4" name="content_text_4" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 " placeholder="Wpisz treść tutaj">{{ old('content_text_4') ? old('content_text_4') : $blog->content_text_4}}</textarea>
                        ...
                        <div class="mb-6">
                            ...
                            <ul class="grid w-full gap-6 md:grid-cols-3" id="photoGrid2">
                                ...
                                @foreach($photos as $index => $photo)
                                <li class="{{ $index >= 9 ? 'hidden' : '' }}">
                                    <input @if(old('photo2')==$photo->getFilename())
                                    checked
                                    @else
                                    {{ $blog->content_photo_2 == $photo->getFilename() ? 'checked' : '' }}
                                    @endif name="photo2" type="radio" id="photo2-{{ $photo->getFilename() }}" value="{{ $photo->getFilename() }}" class="hidden peer">
                            ...
                            <!-- "Show More" button -->
                            <button id="showMoreBtn2" type="button" class="mt-8 text-white bg-indigo-500 hover:bg-indigo-600 focus:ring-4 focus:ring-indigo-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 focus:outline-none"><i class="fa-solid fa-caret-down mr-2"></i>Pokaż więcej</button>
                            @error('photo2')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="content_text_5" name="content_text_5" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 " placeholder="Wpisz treść tutaj">{{ old('content_text_5') ? old('content_text_5') : $blog->content_text_5}}</textarea>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="content_text_6" name="content_text_6" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 " placeholder="Wpisz treść tutaj">{{ old('content_text_6') ? old('content_text_6') : $blog->content_text_6}}</textarea>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="content_text_7" name="content_text_7" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 " placeholder="Wpisz treść tutaj">{{ old('content_text_7') ? old('content_text_7') : $blog->content_text_7}}</textarea>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="content_text_8" name="content_text_8" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 " placeholder="Wpisz treść tutaj">{{ old('content_text_8') ? old('content_text_8') : $blog->content_text_8}}</textarea>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="end" name="end" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Wpisz treść tutaj">{{ old('end') ? old('end') : $blog->end}}</textarea>
                            @error('end')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-6">
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" name="visibility_on_website" value="1" class="sr-only peer" {{ old('visibility_on_website', $blog->visibility_on_website) ? 'checked' : '' }}>
                        ...
                        <div class="mb-6">
                            ...
                            <input value="{{ old('seo_title') ? old('seo_title') : $blog->seo_title}}" type="text" name="seo_title" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Brazil Santos" required>
                            @error('seo_title')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <input value="{{ old('seo_description') ? old('seo_description') : $blog->seo_description}}" type="text" name="seo_description" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Wysokiej jakości kawa z Brazylii" required>
                        ...
                        <div class="mb-6">
                            ...
                            <input value="{{ old('seo_keywards') ? old('seo_keywards') : $blog->seo_keywards}}" type="text" name="seo_keywards" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Wysokiej jakości kawa z Brazylii" required>
                            @error('seo_keywards')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="mb-6">
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input name="visibility_in_google" type="checkbox" value="1" class="sr-only peer" {{ old('visibility_in_google', $blog->visibility_in_google) ? 'checked' : '' }}>
                                <div class="w-11 h-6 bg-gray-200 rounded-full peer peer-focus:ring-4 peer-focus:ring-blue-300 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
