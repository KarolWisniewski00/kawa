                ...
                <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
                    ...
                    <form action="{{route('dashboard.blog.update', $blog->id)}}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <ul class="grid w-full gap-6 md:grid-cols-3" id="photoGrid">
                                ...
                                <li class="{{ $index >= 9 ? 'hidden' : '' }}">
                                    <input
                                    @if(old('photo') == $photo->getFilename())
                                    checked
                                    @else 
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="content" name="content" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Wpisz treść tutaj">{{ old('content') ? old('content') : $blog->content}}</textarea>
                            @error('content')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
