                ...
                <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
                    ...
                    <div class="flex flex-row justify-between">
                        <h1 class="mt-8 mb-4 text-2xl font-medium text-gray-900">
                            Tworzenie zdjęcia z instagrama
                        </h1>
                    ...
                    <form action="{{route('dashboard.technic.instagram.store')}}" method="POST">
                        @csrf
                        <div class="mb-6">
                            <label for="text" class="block mb-2 text-sm font-medium text-gray-900">Link</label>
                            <input value="{{ old('url') ? old('url') : ''}}" name="url" type="text" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " placeholder="Tutaj wklej adres url do zdjęcia z instagrama" required>
                            @error('url')
                        ...
                        <div class="mb-6">
                            ...
                            <input value="{{ old('order') ? old('order') : 0}}" name="order" type="number" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Tutaj wklej adres url do zdjęcia z instagrama" required>
                            @error('order')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
