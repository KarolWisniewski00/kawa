                ...
                <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
                    ...
                    <form action="{{route('dashboard.technic.instagram.update', $instagram->id)}}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input value="{{ old('url') ? old('url') : $instagram->url}}" name="url" type="text" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" placeholder="Tutaj wklej adres url do zdjęcia z instagrama" required>
                            @error('url')
                        ...
                        <div class="mb-6">
                            ...
                            <input value="{{ old('order') ? old('order') : $instagram->order}}" name="order" type="number" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" placeholder="Tutaj wklej adres url do zdjęcia z instagrama" required>
                            @error('order')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
