    ...
    <div class="cookies__alert">
        <div class="cookies__container">
            <div class="cookies__wrapper">
                <h2 class="cookies__title font-custom h1">@lang('cookieConsent::cookies.title')</h2>
                ...
                <div class="cookies__actions">
                    @cookieconsentbutton(action: 'accept.essentials', label: __('cookieConsent::cookies.essentials'), attributes: ['class' => ''])
            ...
            <form action="{{ route('cookieconsent.accept.configuration') }}" method="post" class="cookies__customize">
                ...
                <div class="cookies__sections">
                    ...
                    <div class="cookies__section">
                        ...
                        <a href="#cookies-policy-{{ $category->key() }}" class="cookies__details text-info">@lang('cookieConsent::cookies.details.more')</a>
                    </div>
                    @endforeach
                </div>
